...
BAD_WORDS = {
    ...
    'остоебенило', 'остопиздеть', 'остопиздело', 'остохуело', 'остохуеть', 'отдрачивать', 'отдрачиваться',
...
async def reply_praise(update, context):
    await update.message.reply_text("Картики если честнотак себе... Мне не нравится. Переделывай!")
...
async def help_command(update, context):
    await update.message.reply_text(
        "Я реагирую на:\n"
        "📷 Фото → «Картики если честнотак себе... Мне не нравится. Переделывай!»\n"
